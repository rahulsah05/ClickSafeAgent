...
This repository is currently at Phase 6: backend URL validation, SQLite persistence, isolated Playwright browser capture, technical analyzers, reputation-service integration, and AI verdict generation are implemented.
...
- `POST /api/v1/analyze` validates and normalizes a URL, persists an analysis job, runs browser capture, technical/reputation checks, AI verdict generation, and returns the current Phase 6 job payload.
